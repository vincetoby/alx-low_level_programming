...
7. [**100-argstostr.c**](https://github.com/vincetoby/alx-low_level_programming/blob/master/0x0B-malloc_free/100-argstostr.c): Concatenates all arguments of argv(a 2D array).
